...
dosims <- function(NAI) {
    ...
    #' **While we provide the code this year, note we did not actually consider approach for N = 200 in the manuscript because it was computationally very intensive, taking over 20 hrs on the HPC with the session Information provided below.**
    ##------------------
    tic <- proc.time()
