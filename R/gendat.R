...
#'
#' @details # Warning
#' Note **no** checks are made on the argument \code{Sigma} to see if it is a positive definite matrix. Please be careful about this!
#'
#'
#' @author Francis K.C. Hui <francis.hui@anu.edu.au>
#'
#'
#' @seealso [coque()] for the main function for constructing a COQUE fit, [estimates.coque()] for extracting values from a COQUE fit, and [stackedGLMMs()] for fitting stacked univariate generalized linear mixed models.
#'
#'
#' @examples
#' \dontrun{
